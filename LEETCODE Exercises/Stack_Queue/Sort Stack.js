...
// ми сортуємо в порядку в стеку tempStack
// 1. перший елемент з stack перекидаємо в temp і в tempStack
// 2. знову з stack верхній елемент присвоюємо temp, якщо в tempStack верхній елемент
// більший за temp перекидаємо його в stack, а в tempStack пушимо temp, і так до кінця
